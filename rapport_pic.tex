...
\newpage
	...
	\begin{figure}[h!]
	   \center
	   \includegraphics[scale=1]{points_categorie_adultes.png}
	...
	\begin{figure}[!h]
	   \center
	   \includegraphics[scale=0.9]{points_categorie_jeunes.png}
	...
	\begin{figure}[!h]
	   \center
	   \includegraphics[scale=0.9]{recapitulatif_modalite_challenge.png}
	...
	\begin{figure}[!h]
	   \center
	   \includegraphics[scale=0.9]{Diagramme_Gantt.png}
...
\begin{figure}[!h]
	   \center
	   \includegraphics[scale=0.9]{Diagramme_cas_utilisation_organisation_course.png}
...
\begin{figure}[!h]
	   \center
	   \includegraphics[scale=0.9]{Diagramme_cas_utilisation_administration_challenge.png}
...
\begin{figure}[!h]
	   \center
	   \includegraphics[scale=0.9]{Diagramme_cas_utilisation_consultation_resultats.png}
...
\begin{sidewaysfigure}[!h]
	   \center
	   \includegraphics[scale=0.9]{Diagramme_classes.png}
