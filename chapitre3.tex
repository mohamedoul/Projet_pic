...
Commencez par noter ce que vous attendez du test du logiciel, les problèmes que vous prévoyez, et la liste des personnes dont vous avez besoin pour effectuer ces tests. 
\subsection {Schéma des tests}

\subsubsection{Outil classement}
Les tests revêtent une importance capitale avant, lors et après le déploiement de logiciel sur le serveur. En effet, ils permettent d'identifier un nombre maximum de comportements problématiques du logiciel afin d'en augmenter la qualité.
\subsubsection{Outil challenge}
