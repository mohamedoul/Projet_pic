...
Ce chapitre est l’occasion pour présenter les différents langages et outils utilisés pour réaliser le projet. Également, la mise en avant des différentes interfaces mises en œuvre pour l’exécution des différentes fonctionnalités. Enfin les tests effectués pour s’assurer du bon fonctionnement de logiciel.
...
Pour rappel, un code R qui calculait ces classements nous a été fourni. Nous avons travaillé dessus, puis remis à jour.
...
La documentation du projet consiste à commenter toutes les fonctions pour faciliter la compréhension du codes et les changements futurs à effectuer.
...
\begin{itemize}
\item Tester la modification des entêtes du fichiers Excel
...
Dans cette optique, nous avons décidé d'effectuer des tests unitaires pour chaque fonctionnalité implémentée, un test global pour l'ensemble du projet et à la fin un test d'acceptation lors du déploiement du projet sur le serveur dédié.\\
