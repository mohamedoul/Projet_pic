...
\end{sidewaysfigure}
 ...
 \begin{itemize}
\item La définition des besoins du le maître d'ouvrage
\item Le choix du langage R et du Serveur Shiny pour l'implémentation du projet
\item La formation su les langages à utiliser qui a duré le long du processus du développement du projet
\item Implémentation des fonctionnalités souhaitées par le client en se basant le code R fourni
\item Effectuer des tests nécessaire sur chaque fonctionnalité
