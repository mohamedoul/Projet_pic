...
\end{sidewaysfigure}
	\newpage
   Comme il est clairement illustré dans ce diagramme, le déroulement du projet s'est fait en plusieurs citées comme suit:\\
-La définition des besoins du le maître d'ouvrage; \\
-Le choix du langage R et du Serveur Shiny pour l'implémentation du projet;\\
-La formation su les langages à utiliser qui a duré le long du processus du développement du projet;\\
-Implémentation des fonctionnalités souhaitées par le client en se basant le code R fourni;\\
-Effectuer des tests nécessaire sur chaque fonctionnalité;\\
-Déploiement de l'application sur serveur de test et réaliser le test d'acceptance sur l'ensemble des fonctionnalités;\\
-La documentation du code: cette étape est cruciale pour faciliter la comprhénsion du code, l'utilité de chaque fonction et également pour faciliter les étapes futures  de l'évolution du code.
-La rédaction du rapport qui est une étape faite en parallèle des autres.
