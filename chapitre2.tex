...
\newpage
Ainsi la figues ci-dessous illustre clairement le cas d’utilisation de cette étape.
...
Le diagramme de classes du projet est illustré par la figure présente page suivante.
